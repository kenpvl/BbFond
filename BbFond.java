...
public class BbFond {
    ...
    public static void main(String[] args) {
        ...
        if (comanda==3){
                            ...
                            if (fond[idizd].tip.equals("kniga")) { fond[idizd].printIK();}
                             
                            if (fond[idizd].tip.equals("jurnal")) { fond[idizd].printIJ();}
        
                            if (fond[idizd].tip.equals("broshura")) { fond[idizd].printIB();}
        ...
        if (tipizd.equals("k")){
                       ...
                       if (tipizd.equals("b")){
                             ...
                             fond[granica+1]=new Kniga(granica+1,"broshura","pusto",naimenb,godizb,"pusto",izdatb,"pusto",kratopis,"pusto");
                 ...
                 if (tipizd.equals("j")){
                             ...
                             fond[granica+1]=new Kniga(granica+1,"jurnal","pusto",naimenj,godizj,kolvostrj,izdatj,"pusto","pusto",spisoks);
